...
import Util.Rutinas;
import Vista.JFrameGuardarObra;
...
public class ControladorGuardarObra implements ActionListener,KeyListener
{
   private JFrameGuardarObra formObra; 

    public ControladorGuardarObra() 
    {
        formObra = new JFrameGuardarObra();
